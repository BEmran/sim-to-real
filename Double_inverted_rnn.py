...
def optimize_model():
    ...
    expected_state_action_values = (next_state_values * (1 - eps_threshold) + reward_batch)
...
policy_net = ClassFile.DQN().to(device)
target_net = ClassFile.DQN().to(device)
...
print('Model Saved - policy_net.pth')
#plot_thresh()
